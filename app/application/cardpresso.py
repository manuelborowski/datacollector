        ...
        try:
            ...
            if update_students:
                ...
                if file_updated:
                    ...
                    log.info(f'cardpresso students: updated: {nbr_updated_students}/')
                    shutil.copyfile(local_temp_file, local_file)
        except Exception as e:
            log.eror(f'cardpresso job task: {e}')


mcron.subscribe_cron_task(CronTaskSequence.CARDPRESSO, update_cardpresso, None)
